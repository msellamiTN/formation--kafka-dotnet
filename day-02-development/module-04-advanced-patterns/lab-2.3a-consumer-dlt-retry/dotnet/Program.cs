...
var topic = Environment.GetEnvironmentVariable("KAFKA_TOPIC") ?? "banking.transactions";
var groupId = Environment.GetEnvironmentVariable("KAFKA_GROUP_ID") ?? "dlt-retry-consumer-group";
var autoOffsetReset = Environment.GetEnvironmentVariable("KAFKA_AUTO_OFFSET_RESET") ?? "earliest";
var dltTopic = Environment.GetEnvironmentVariable("KAFKA_DLT_TOPIC") ?? "banking.transactions.dlq";
