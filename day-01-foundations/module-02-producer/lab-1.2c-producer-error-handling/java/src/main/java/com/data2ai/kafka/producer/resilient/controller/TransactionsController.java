...
import com.data2ai.kafka.producer.resilient.service.ProducerMetrics;
import com.data2ai.kafka.producer.resilient.service.TransactionProducerService;
...
public class TransactionsController {
    ...
    public CompletableFuture<ResponseEntity<Map<String, Object>>> create(@Valid @RequestBody Transaction tx) throws Exception {
        return producerService.sendWithRetryAsync(tx)
    ...
    @GetMapping("/metrics")
    public ResponseEntity<ProducerMetrics> metrics() {
